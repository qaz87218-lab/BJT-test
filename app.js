(() => {
  ...
  const LISTENING_BOOKS = [
    ...
    {id:'LISTENING_BOOK_02',order:2,title:'第2冊',sourceLabel:'待新增真題',placeholder:true},
    {id:'LISTENING_BOOK_03',order:3,title:'第3冊',sourceLabel:'待新增真題',placeholder:true}
  ];
